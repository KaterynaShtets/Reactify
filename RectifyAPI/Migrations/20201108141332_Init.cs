    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TesterUsers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducntId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Indicators_TesterUsers_TesterUserId",
                        column: x => x.TesterUserId,
                        principalTable: "TesterUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodOxygenLevel = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndicatorsInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IndicatorsInfo_Indicators_IndicatorsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Indicators_ProductId",
                table: "Indicators",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Indicators_TesterUserId",
                table: "Indicators",
                column: "TesterUserId");

            migrationBuilder.CreateIndex(
                name: "IX_IndicatorsInfo_IndicatorsId",
